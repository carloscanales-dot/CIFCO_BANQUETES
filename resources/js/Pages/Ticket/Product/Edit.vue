<template>
  ...
  <AdminLayout>
    ...
    <!-- TÍTULO + BREADCRUMBS -->
    <div class="mb-4">
      <h5 class="text-h5 font-weight-bold">Actualización del producto</h5>
      ...
      <VForm @submit.prevent="submit">
        ...
        <VCardText class="pt-4">
          ...
          <VRow dense class="mt-1">
            ...
            <!-- RADIOGROUP ELEGANTE Y COMPACTO -->
            <VCol cols="12" md="6">
              <VRadioGroup v-model="form.status" :error-messages="errors.status" inline hide-details
                class="compact-radio pt-2" label="">
                <VRadio :value="true" label="Activo" color="grey-darken-3" density="compact" />
                <VRadio :value="false" label="Inactivo" color="grey-darken-3" density="compact" />
              </VRadioGroup>
            </VCol>
          </VRow>
        ...
        <VCardActions class="px-4 pb-4">
          <VBtn prepend-icon="mdi-database" :disabled="isLoading" type="submit" color="black" variant="flat"
            class="text-white">
            Guardar
          </VBtn>

          <Link href="/ticket/product" as="div">
          <VBtn prepend-icon="mdi-cancel" variant="outlined" color="grey-darken-3" @click="productStore.resetForm()">
            Cancelar
          </VBtn>
          </Link>
        </VCardActions>
